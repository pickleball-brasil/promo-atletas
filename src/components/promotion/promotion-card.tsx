...
export function PromotionCard({ promotion }: PromotionCardProps) {
  ...
  return (
    <article
      ...
      className="surface-card overflow-hidden rounded-xl transition duration-200 hover:-translate-y-0.5 hover:shadow-lg"
    >
      ...
      <div className="space-y-2.5 p-3">
        ...
        <div className="space-y-0.5 rounded-lg border border-neutral-300/80 bg-white p-2">
        ...
        {usableCoupon ? (
          <div className="rounded-lg border border-neutral-300/80 bg-neutral-50 p-2">
            ...
            <div className="mt-1 flex items-center justify-between gap-2">
              <code
                ...
                className="rounded-md bg-white px-2 py-1 font-mono text-xs font-semibold text-neutral-900"
              >
                {usableCoupon.code}
              </code>
              <CopyCouponButton
                ...
                className="min-h-8 rounded-md border border-brand-500 px-2 py-1 text-[11px] font-semibold text-brand-500 transition duration-200 hover:bg-brand-50"
              />
            </div>
          </div>
        ) : null}
