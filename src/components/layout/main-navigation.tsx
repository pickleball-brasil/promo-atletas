...
const socialLinks = [
  {
    ...
    label: 'Telegram',
    colorClass: 'hover:text-[#229ED9] hover:bg-[#229ED9]/10',
    icon: (
  ...
  {
    href: 'https://instagram.com/promoatletas',
    label: 'Instagram',
    colorClass: 'hover:text-[#E1306C] hover:bg-[#E1306C]/10',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-4" aria-hidden>
  ...
  },
  {
    ...
    label: 'WhatsApp',
    colorClass: 'hover:text-[#25D366] hover:bg-[#25D366]/10',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-4" aria-hidden>
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-neutral-300/80 glass-panel">
      <div className="mx-auto flex w-full max-w-7xl items-center gap-2 px-4 py-2 sm:gap-4 sm:px-6 sm:py-3">
        ...
        <Link
          href="/promocoes"
          className="mr-1 shrink-0 text-base font-extrabold text-neutral-900 sm:mr-2 sm:text-lg"
        >
        ...
        <div className="ml-auto flex items-center gap-0.5 sm:gap-1" role="list" aria-label="Redes sociais">
          {socialLinks.map((social) => (
            <a
              ...
              title={social.label}
              role="listitem"
              className={`inline-flex size-9 items-center justify-center rounded-xl text-neutral-500 transition duration-200 hover:-translate-y-0.5 ${social.colorClass}`}
            >
              {social.icon}
            </a>
          ))}
